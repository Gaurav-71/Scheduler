<template>
  <div class="mapping">
    <div class="container">
      <mappingTable
        v-if="
          $store.state.semester == 'Third Semester' &&
          $store.state.section == 'A'
        "
      ...
      <mappingTable
        v-if="
          $store.state.semester == 'Third Semester' &&
          $store.state.section == 'C'
        "
        :sectionObject="$store.state.sec3c"
      />
      <mappingTable
        v-if="
          $store.state.semester == 'Fourth Semester' &&
          $store.state.section == 'A'
        "
      ...
      <mappingTable
        v-if="
          $store.state.semester == 'Fifth Semester' &&
          $store.state.section == 'A'
        "
      ...
      <mappingTable
        v-if="
          $store.state.semester == 'Sixth Semester' &&
          $store.state.section == 'A'
        "
      ...
      <mappingTable
        v-if="
          $store.state.semester == 'Seventh Semester' &&
          $store.state.section == 'A'
        "
      ...
      <mappingTable
        v-if="
          $store.state.semester == 'Eight Semester' &&
          $store.state.section == 'A'
        "
